...
from ecom.views import LogoutWithGet
urlpatterns = [
    path('admin/', admin.site.urls),
    path('products/<int:category_id>/',views.home_view,name='products'),
    path('',views.home_view_category,name=''),
    path('home_view_category',views.home_view_category,name='home_view_category'),
    path('afterlogin', views.afterlogin_view,name='afterlogin'),
    #path('logout', LogoutView.as_view(template_name='ecom/logout.html'),name='logout'),
    path('logout', LogoutWithGet.as_view(template_name='ecom/logout.html'), name='logout'),
    ...
    path('login', views.login,name='login'),
    path('indexN', views.indexN,name='indexN'),
    ]

from django.conf import settings
from django.conf.urls.static import static
from django.urls import path
# your other imports and urlpatterns
