...
from .models import Product, Category # Import your Product model
from .forms import CategoryForm
def home_view(request, category_id):
    ...
    return render(request,'ecom/index.html',{'products':products,'product_count_in_cart':product_count_in_cart, 'category': category})


    
def home_view_category(request):
    categories = models.Category.objects.all()
    return render(request, 'ecom/index1.html', {'categories': categories})
...
def admin_dashboard_view(request):
    ...
    categorycount=models.Category.objects.all().count()
...
def admin_category_view(request):
    ...
    return render(request,'ecom/admin_category.html',{'category':category})
...
def delete_category_view(request,pk):
    product=models.Category.objects.get(id=pk)
    product.delete()
...
class LogoutWithGet(LogoutView):
    ...
    def get(self, request, *args, **kwargs):
        """Log out may be done via GET for convenience."""
        return self.post(request, *args, **kwargs)
    
def contect(request):
    return render(request, 'ecom/contect.html')

def indexN(request):
    return render(request, 'ecom/indexN.html')
